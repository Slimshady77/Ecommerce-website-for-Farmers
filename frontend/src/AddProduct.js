  ...
  return (
    <div>
      ...
      <div class="container text-center">
        ...
        <div class="input-group">
          <input type='text' className='form-control' name="prod"  value={user.prod} onChange={handleChange}></input>
          </div>
          
          <div class="input-group">
          <input type='text' className='form-control' name="desc"  value={user.desc} onChange={handleChange}></input>
          </div>

          <div class="input-group">
          <input type='text' className='form-control' name="price"  value={user.price} onChange={handleChange}></input>
          </div>
